...
<?php if((isset($_SESSION['user'])) && ($_SESSION['userType'] == 'admEmpresa')) : ?>
    ...
    ?>
<div class="retangulo"> 
    <img class="img" src="<?php echo base_url("assets/IMG/adminSite/pontoOnibus.png")?>" alt="" width="250" height="200">
            ...
            <tr class="trTable">
                ...
                <?php foreach ($ponto as $pontos):?>
                    <tr>
                        ...
                        <td><a href="<?php echo base_url('/public/adminEmpresa/relacionarPonto');?>/<?php echo $pontos->id?>">Adicionar Ponto</a></td>
                    </tr>                              
                <?php endforeach ?>
            </tr>
        </table>
    ...
    <ul>
       <ol>
            <a href="<?php echo base_url('public/adminEmpresa/tabelaPonto');?>"><button class="btn Reg btn-lg" style="width: 200px;">Voltar</button></a>
       </ol>
    </ul>
</div>
<?php else : ?>
