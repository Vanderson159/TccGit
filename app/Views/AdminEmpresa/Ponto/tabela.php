...
<div class="retangulo"> 
    ...
    <img class="img" src="<?php echo base_url("assets/IMG/adminEmpresa/pontoOnibus.png")?>" alt="" width="250" height="200">
        ...
        <table class="tabela">
            <tr class="trTable">
                ...
                <?php foreach ($linha as $linhas):?>
                    <tr>
                        <td value="<?php echo $linhas->id?>"><?php echo $linhas->nome?></td>  
                        <td><a class="editar" href="<?php echo base_url('/public/adminEmpresa/adicionarPonto');?>/<?php echo $linhas->id?>">Adicionar Pontos</a></td>
                    </tr>                                  
                <?php endforeach ?>
            </tr>
        </table>
