...
<div class="retangulo"> 
    ...
    <ul>
       <ol>
            <a href="<?php echo base_url('public/adminEmpresa/cadOnibus');?>"><button class="btn btn-lg" style="width: 210px;">Inserir Ônibus</button></a>
       </ol>
       <ol>
