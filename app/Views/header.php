<html lang="pt-br">
  <head>
    ...
    <!-- links login -->
    <link rel="stylesheet" type="text/css" href="/assets/css/login/bootstrap.min.css"></link>
    <!-- Style -->
    ...
    <!-- link do style da página de busca do user-->
          ...
          <div class="row align-items-center position-relative">
            ...
            <div class="col-lg-4 text-center">
              <div class="logo" style="color: black;">
                <a href="<?php echo base_url('public/home')?>" style="color: black;" >My Bus</a>
              </div>
            ...
            <div class="col-lg-4">
              <nav class="site-navigation text-left mr-auto " role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto d-none d-lg-block">
                  <li><a href="about.html" class="nav-link" style="font-size: 1.3rem;">Passagens</a></li>
                  <li><a href="blog.html" class="nav-link" style="font-size: 1.3rem;">Contato</a></li>
                  <li><a href="contact.html" class="nav-link" style="font-size: 1.3rem;">Sobre</a></li>
                </ul>
              </nav>
            </div>
