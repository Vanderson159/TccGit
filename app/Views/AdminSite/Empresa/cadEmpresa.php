...
<?php if(isset($_SESSION['user'])) : ?>
    ...
    <div class="retangulo"> 
        ...
        <?php
            if($acao == "Inserir"){
                $form = base_url("public/admin/inserirEmpresa");
                $statusId = "enabled";
            }else{
                if($acao == "Editar"){
                    $form = "";
        ...
        <form id="formInserir"  method="post" action="<?php echo $form?>">
            <ul>
                <ol>
                    <label class="label">Id (CNPJ):&nbsp;&nbsp;</label>
                    <input name="id" id="id" type="number" class="form-control" value="<?php echo (isset($empresa) ? $empresa->id : '97547215634587')?>" placeholder="CNPJ" required autofocus <?php echo $statusId?>>
                </ol>
                <br>
                <ol>
                    <label class="label">Login:&nbsp;&nbsp;</label>
                    <input name="login" id="login" type="text" class="form-control" value="<?php echo (isset($empresa) ? $empresa->login : 'userNogueira')?>" placeholder="Seu Login" required autofocus>
                </ol>
                <br>
                <ol>
            ...
            <ul>
                ...
                <br>
                <ol>
                    <a href=" <?php echo base_url('public/admin/tabelaEmpresa')?>"><label class="btn btn-lg voltar">Voltar</label></a>
                </ol>
            </ul>
        </form>
        </div>
